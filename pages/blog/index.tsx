...
const Services =  ({blog}:{blog:productItem[]}) => {
    const [pagination, setPagination] = useState(1)
    const {t, i18n} = useTranslation('common')
    return typeof blog !== 'string' ? <>
        <Head>
            <title>{t('blog')}</title>
        </Head>
        <div id="site-main" className="site-main">
            <div id="main-content" className="main-content">
                <div id="primary" className="content-area">
                    <PageTitle pageTitle={t('blog')} currentAddress={t('blog')}/>
                    ...
                    <div id="content" data-aos="fade-zoom-in"
                        ...
                        <div className="section-padding">
                            <div className="section-container p-l-r">
                                            ...
                                            <div className="tab-content">
                                                <div className="tab-pane fade show active" id="layout-grid" role="tabpanel">
                                                    <div className="products-list grid">
                                                        <div className="row">
                                                            {blog.slice((pagination - 1) * 10, (pagination - 1) * 10 + 10).map(item => {
                                ...
                                <Pagination  pagination={pagination} data={blog} setPagination={setPagination}/>
                            </div>
                        </div>
                    </div>
                </div>
...
export async function  getServerSideProps(context:any) {
    const {query} = context
    const blog = await fetch(process.env['NEXT_PUBLIC_MAIN_PATH'] + '/blog/')
