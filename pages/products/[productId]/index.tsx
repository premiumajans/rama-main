...
const ProductItem = ({product}:{product:productItem}) => {
    ...
    return <>
        <Head>
            ...
            <title>
                {current?.name ? current?.name + ' | RAMA GROUP' : 'RAMA GROUP'}
            </title>

            <meta property="og:title" content={current?.name ? current?.name + ' | RAMA GROUP' : 'RAMA GROUP'}/>
                    ...
                    <div id="main-content" className="main-content">
                        <div id="primary" className="content-area">
                            ...
                            <div id="content" data-aos="fade-zoom-in"
                                ...
                                <div className="shop-details zoom" data-product_layout_thumb="scroll"
