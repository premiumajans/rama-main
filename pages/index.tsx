                ...
                <Slider {...settings}>
                    {Array.isArray(sliders) && sliders.map(item => {
                        ...
                        return <li key={item.id} style={{height:'100vh'}}>
                            <video style={{objectFit:'fill', height:'80vh'}} playsInline autoPlay loop muted width="100%" height="100%"
                            ...
                            <div data-aos="fade-zoom-left"
                                ...
                                <div className="full full_h after_logo">
                                    <div className="slider_content home_slide_content" style={{paddingTop: "0px"}}><h1></h1>
                                        <h2></h2><h1><span style={{color: "#00b7ce"}}>{translated?.title}</span></h1>
