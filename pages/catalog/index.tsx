...
const Catalog =  ({catalog}:{catalog:productItem[]}) => {
        ...
        <div id="site-main" className="site-main">
            <div id="main-content" className="main-content">
                <div id="primary" className="content-area">
                    <PageTitle pageTitle={t('catalog')} currentAddress={t('catalog')}/>
                    ...
                    <div id="content" data-aos="fade-zoom-in"
                        ...
                        <div className="section-padding">
                            <div className="section-container p-l-r">
                                            ...
                                            <div className="products-topbar clearfix">
                                                <div className="products-topbar-left">
                                                    <div className="products-count">
                                                        {t('showing-result') + catalog?.length}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="tab-content">
                                                <div className="tab-pane fade show active" id="layout-grid" role="tabpanel">
                                                    <div className="products-list grid">
                                                        <div className="row">
                                                            {catalog.slice((pagination - 1) * 10, (pagination - 1) * 10 + 10).map(item => {
                                                                return <Link key={item.id} href={'/catalog/' + item.id}
                                ...
                                <Pagination  pagination={pagination} data={catalog} setPagination={setPagination}/>
                            </div>
                        </div>
                    </div>
                </div>
...
export async function  getServerSideProps(context:any) {
    const catalog = await fetch(process.env['NEXT_PUBLIC_MAIN_PATH'] + '/catalog/')
