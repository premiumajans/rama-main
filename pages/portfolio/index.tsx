                            ...
                            <div className="row">
                                {Array.isArray(portfolio) ? <>
                                    {portfolio.map(item => {
                                        ...
                                        return <Link key={item.id} className="col-md-12 col-lg-4  mb-4 sm-m-b-50" href={'/portfolio/' + item.id}>
                                            <div className="block-widget-banner layout-5">
                                                <div className="bg-banner">
                                                    <div className="banner-wrapper banners">
                                                        <div className="banner-image">
                                                            <a href="shop-grid-left.html">
                                                                <Image style={{maxHeight:400, height:400}} width="496" height="577" src={process.env['NEXT_PUBLIC_MAIN_PATH_WITHOUT_API'] + item.photo}
                                                                       alt={translated?.name!}/>
                                                            </a>
                                                        </div>
                                                        <div className="banner-wrapper-infor">
                                                            <div className="info">
                                                                <div className="content">
                                                                    <a className="link-title" href="shop-grid-left.html">
